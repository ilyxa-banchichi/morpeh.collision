    ...
    internal static class CommonTypeIdentifier {
        ...
        internal static void GetID<T>(out long id, out int offset) where T : struct, IComponent {
            ...
            var info = new InternalTypeDefinition {
                ...
                offset                  = offset,
                type                    = type,
                entityGetComponentBoxed = (entity) => World.Default.GetStash<T>().Get(entity),
                entitySetComponentBoxed = (entity, component) => World.Default.GetStash<T>().Set(entity, (T)component),
                entityRemoveComponent   = (entity) => World.Default.GetStash<T>().Remove(entity),
